...
export function Todos() {
  ...
  /* Implement useEffect to fetch all todos. Hints are at the bottom of the file. DONE*/
  useEffect(() => {
  ...
  /* Implement addTodo to add a new todo. Hints are at the bottom of the file. DONE*/
...
fetch('/api/todos', {
  ...
  /* Implement toggleCompleted to toggle the completed state of a todo. Hints are at the bottom of the file. DONE*/
  async function toggleCompleted(todo: Todo) {
    todo.isCompleted = !todo.isCompleted;
  fetch(`/api/todos/${todo.todoId}`, {
    method: 'PUT',
    headers: {
      'Content-Type': 'application/json',
    },
